...
App code can depend on this module when it needs authentication state without depending on Firebase, Google Credential Manager, or a specific auth provider.
