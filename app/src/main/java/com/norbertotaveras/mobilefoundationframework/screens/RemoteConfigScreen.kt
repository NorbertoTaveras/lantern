...
import com.norbertotaveras.mobilefoundation.remoteconfig.firebase.FirebaseRemoteConfigProviderConfig
import com.norbertotaveras.mobilefoundation.remoteconfig.firebase.FirebaseRemoteConfigValueType
...
private val demoRemoteConfigDefaults = RemoteConfigDefaults(
    values = mapOf(
        welcomeMessageKey to RemoteConfigValue.StringValue("Welcome to Mobile Foundation SDK"),
